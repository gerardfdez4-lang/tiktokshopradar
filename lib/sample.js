...
const DEMO_HANDLES = ["@glow.queen", "@deal.hunter", "@viral.finds", "@tiktokmademebuy", "@that.girl.faves", "@budget.beauty"];

function demoVideos(seed) {
  return Array.from({ length: 6 }, (_, i) => ({
    id: `vid-${seed}-${i}`,
    cover: null,
    url: "https://www.tiktok.com",
    creator: DEMO_HANDLES[i % DEMO_HANDLES.length],
    views: 1_240_000 - i * 185_000,
    likes: 96_000 - i * 12_500,
  }));
}

function demoCreators() {
  return [
    { name: "Glow Queen", handle: "@glow.queen", followers: 842000 },
    { name: "Deal Hunter", handle: "@deal.hunter", followers: 511000 },
    { name: "Viral Finds", handle: "@viral.finds", followers: 1240000 },
    { name: "TikTok Made Me", handle: "@tiktokmademebuy", followers: 388000 },
    { name: "That Girl Faves", handle: "@that.girl.faves", followers: 205000 },
  ];
}
